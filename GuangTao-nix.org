...
** Nix [[file:GuangTao-rust.org][GuangTao's Rust]]
:PROPERTIES:
...
** Nix [[file:GuangTao-haskell.org][GuangTao's Haskell]]
:PROPERTIES:
...
** Nix [[file:GuangTao-python.org][Python]]
:PROPERTIES:
...
** Nix [[file:GuangTao-golang.org][GuangTao's Golang]]
:PROPERTIES:
...
** Nix [[file:GuangTao-clang.org][GuangTao's Clang]]
