...
#+DATE: 2020-11-29 Sun
#+SETUPFILE: ~/Dropbox/org-notes/braindump/hugo.setup
#+SETUPFILE: ~/Dropbox/org-notes/braindump/theme-readtheorg.setup
#+SETUPFILE: ~/Dropbox/org-notes/braindump/tags/nix-tags.setup
#+OPTIONS:   H:3 num:t toc:t \n:nil @:t ::t |:t ^:nil -:t f:t *:t <:t
#+OPTIONS: prop:t p:t

- tags :: [[file:nixos.org][NixOS]], [[file:nixops.org][NixOps]], [[file:../GuangTao-learning-programming-languages.org][GuangTao's learning Programming languages]], [[file:nix-wiki.org][Nix Wiki]]
