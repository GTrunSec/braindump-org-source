...
** Nix [[file:my-haskell.org][Haskell (programming language)]]
:PROPERTIES:
...
#+begin_src md :async t :exports both :results output
...
:frameBorder "0"
:src "https://www.youtube.com/watch?v=h2I1FHpbaIg"
:height "367"
:width "653"}]]
#+end_src
...
"accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
:frameBorder "0"
:src "https://www.youtube.com/watch?v=apIE_TgNNmo"
:height "367"
:width "653"}]]
#+end_src
